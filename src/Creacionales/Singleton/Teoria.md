...
¿Cómo podemos garantizar que una clase tenga una y solo una instancia, mientras proporcionamos un punto de acceso global y único a esa instancia para toda la aplicación?

## Solución:

El Singleton es, esencialmente, una clase que se encarga de crearse a sí misma, de asegurar que solo exista una, y de proporcionar el acceso global a esa única instancia.
